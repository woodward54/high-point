...
public static class HexUtils
{
    ...
    // TODO: I think this is off by 30 degrees depending on how you view it
    // Would need to update WorkerBuild system if this is changed
    ...
    public static int SideIndex(float angle)
    {
