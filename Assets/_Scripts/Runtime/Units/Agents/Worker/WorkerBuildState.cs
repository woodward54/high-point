...
public class WorkerBuildState<TStateType> : AttackState<TStateType>
{
    ...
    public WorkerBuildState(Unit unit, bool slew = true) : base(unit, unit.transform, slew)
    {
    ...
    protected override void ExecuteAttack()
    {
        ...
        else
        {
            ...
            var totalLaddersNeeded = heightDiff / 2f;
            ...
            var ladderYPos = startCell.Terrain.transform.position.y + curLadderIndex * 2f * HexGrid.Instance.YStepSize;
